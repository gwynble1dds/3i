...
<style>
/* Custom Scrollbar - Emerald/Teal Medical Theme */
.custom-scrollbar {
...
<div class="fade-in h-full flex flex-col space-y-6 overflow-y-auto custom-scrollbar">
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden flex-1 flex flex-col min-h-0">
        ...
        <div id="medical-tab-patients" class="medical-tab-content p-6 overflow-y-auto custom-scrollbar flex-1">
        ...
        <div id="medical-tab-visits" class="medical-tab-content hidden p-6 overflow-y-auto custom-scrollbar flex-1">
            <div class="flex justify-between items-center mb-6">
                <div>
        ...
        <div id="medical-tab-officers" class="medical-tab-content hidden p-6 overflow-y-auto custom-scrollbar flex-1">
            <div class="flex justify-between items-center mb-6">
                <div>
...
<div id="med-patient-modal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 max-h-[80vh] overflow-y-auto custom-scrollbar">
